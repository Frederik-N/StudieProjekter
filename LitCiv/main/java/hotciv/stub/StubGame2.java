...
public class StubGame2 implements Game {
  ...
  private Position pos_new_city;


  private Unit red_archer, blue_legion, settler_red, bomb_red;;
  private City red_city, new_city;
  ...
  public void performUnitActionAt( Position p ) {
    if(p.equals(pos_settler_red)) {
      new_city = new StubCity(getPlayerInTurn(),0,GameConstants.ARCHER, GameConstants.foodFocus);
      pos_new_city = p;
