...
class UpdateTool extends NullTool {
  ...
  public void mouseDown(MouseEvent e, int x, int y) {
    ...
    case 5: {
      ...
      case 6: {
        editor.showStatus( "State change: Inspected city now has food workforce focus" );
        game.changeWorkForceFocusInCityAt(new Position(5,5),GameConstants.foodFocus);
        game.setTileFocus(new Position(5,5));
        break;
      }
      case 7: {
        editor.showStatus( "State change: Inspected city now has settler production" );
        game.changeProductionInCityAt(new Position(5,5),GameConstants.SETTLER);
        game.setTileFocus(new Position(5,5));
        break;
      }
    default: {
