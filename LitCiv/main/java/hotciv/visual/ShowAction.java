...
public class ShowAction {
  ...
  public static void main(String[] args) {
    ...
    editor.open();
    editor.showStatus("Shift-Click on red settler to see Game's performAction method being called.");
...
class ActionTool extends NullTool {
  ...
  public void mouseDown(MouseEvent e, int x, int y) {
    if(e.isShiftDown() && editor.drawing().findFigure(x,y) != null && editor.drawing().findFigure(x,y).getClass() == UnitFigure.class) {
